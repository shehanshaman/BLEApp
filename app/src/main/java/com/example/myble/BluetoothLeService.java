...
public class BluetoothLeService extends Service {
    ...
    private void broadcastUpdate(final String action) {
        ...
        Log.e("BluetoothLeService : " , "broadcastUpdate()");
...
//            Log.e("in broadcastUpdate", String.format("%s", new String(data)));
    ...
    public void disconnect() {
        Log.e("BluetoothLeService : " , "disconnect()");
     ...
     */
    public void close() {
        Log.e("BluetoothLeService : " , "close()");
    ...
    public void setCharacteristicNotification(BluetoothGattCharacteristic characteristic,
                                              boolean enabled) {
        Log.e("BluetoothLeService : " , "setCharacteristicNotification()");
        if (mBluetoothAdapter == null || mBluetoothGatt == null) {
            Log.w(TAG, "BluetoothAdapter not initialized");
            return;
        }
    ...
    public List<BluetoothGattService> getSupportedGattServices() {
        Log.e("BluetoothLeService : " , "getSupportedGattServices()");
